...
def my_app(cfg: DictConfig) -> None:
    ...
    result_dir = "/workspaces/stego/results/predictions/{}".format(cfg.experiment_name)
    ...
    for model_path in cfg.model_paths:
        ...
        model = LitUnsupervisedSegmenter.load_from_checkpoint(model_path,strict=True)
...
if __name__ == "__main__":
    prep_args()
    cfg_file = "/workspaces/stego/src/configs/eval_config.yml"
